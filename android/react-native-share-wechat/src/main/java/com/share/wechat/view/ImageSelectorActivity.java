...
import com.share.wechat.utils.Utils;
...
public class ImageSelectorActivity extends FragmentActivity implements ImageSelectorFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .add(R.id.image_grid, new ImageSelectorFragment(urls))
                .commit();
    ...
    private void init() {
        ...
        imageselector_title_bar_layout.setBackgroundColor(getResources().getColor(R.color.photo_bar));
    ...
    protected void onDestroy() {
        setResult(RESULT_CANCELED);
        if (isOk!=1){
            Intent intent=new Intent(getPackageName()+".isShareOk");
