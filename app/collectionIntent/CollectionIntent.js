                    ...
                    <ScrollView style={ styles.container1}>
                        ...
                        <View style={styles.containerChild}>
                            <View style={{flexDirection: 'row', marginTop: Pixel.getPixel(10)}}>
                                ...
                                <Text style={{fontSize: 15, marginRight: 10, color: FontAndColor.COLORA2}}
                                      onPress={() => {
                                          if (this.citiesArray.length + this.provsArray.length >= 5) {
                            ...
                            <LabelSelect
                                ...
                                isBigSize={true}
                            >
                                {this.state.cityArray.filter(item => item.isSelected).map((item, index) =>
                                    <LabelSelect.Label
                                        key={'city-' + index}
                                        data={item}
                                        enables={true}
                                        onCancel={() => {
                                            this.deleteCityItem(item);
                                        }}
                                    >{item.title}
                                    </LabelSelect.Label>
                                )}
