            ...
            <View style={styles.contaier}>
                <View style={styles.contaier}>
                    ...
                    <SGListView
                        ...
                        pageSize={1}
                        renderRow={(item) =>
                            <CarCell style={styles.carCell} carMainText={item} carSubText="奔驰E300L"
                ...
                <SequencingButton buttonClick={this._showSequencingView}/>
                {
                    this.state.isHideSequencing ? (null) : (<SequencingView checkedType={this.state.sequencingType}
                                                                            checkedClick={this._sequencingCheckedClick}
                                                                            hideClick={this._hideSequencingView}/>)
                }
                {
                                                        ...
                                                        <View style={styles.checkedCell}>

                                                            {
                                                                this.state.currentCheckedIndex == 2 ? (
                                                                        <Text
                                                                            style={[styles.checkedCellText, data.title == this.state.checkedCarAgeType && {color: fontAndColor.COLORB0}]}>{data.title}</Text>
                                                                    ) : (
                                                                        <Text
                                                                            style={[styles.checkedCellText, data.title == this.state.checkedCarKMType && {color: fontAndColor.COLORB0}]}>{data.title}</Text>
                                                                    )
                                                            }
