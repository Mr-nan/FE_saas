            ...
            paddingHorizontal:Pixel.getPixel(15)}}>
                ...
                flexDirection: 'row'}}>
                    <View style={{flex:1,alignItems: 'flex-start'}}>
                        <TopBottomText name={'运费'} money={this.props.data.freight_amount} marginTop={Pixel.getPixel(18)}/>
                        <TopBottomText name={'提验车费'} money={this.props.data.check_amount} marginTop={Pixel.getPixel(23)}/>
                    </View>
                    <View style={{flex:1,alignItems: 'center'}}>
                        <TopBottomText name={'保险费'} money={this.props.data.insure_amount} marginTop={Pixel.getPixel(18)}/>
                        <TopBottomText name={'送店费'} money={this.props.data.tostore_amount} marginTop={Pixel.getPixel(23)}/>
                    </View>
                    <View style={{flex:1,alignItems: 'flex-end'}}>
                        <TopBottomText name={'服务费'} money={this.props.data.service_amount} marginTop={Pixel.getPixel(18)}/>
                    </View>
                </View>
                <View style={{width:width-Pixel.getPixel(30),backgroundColor:'#D8D8D8',
                height:1}}></View>
