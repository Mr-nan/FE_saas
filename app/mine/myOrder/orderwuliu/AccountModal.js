                ...
                <TouchableOpacity
                    ...
                    <View style={{width:width-width/4,height:Pixel.getPixel(155),backgroundColor:'#fff',
                     paddingLeft:Pixel.getPixel(20),paddingRight:Pixel.getPixel(20),alignItems: 'center',borderRadius:4}}>
                        <Text style={{fontSize:Pixel.getPixel(20),marginTop: Pixel.getPixel(15)}}>提示</Text>
                        <Text allowFontScaling={false}  style={{textAlign: 'center',fontSize:Pixel.getPixel(14),color:'#000',marginTop: Pixel.getPixel(15)}}>
                            {this.state.content}
                        </Text>
