...
export  default class SupervisionWebScene extends BaseComponent {
    ...
    handleBack = () => {
        ...
        if (oldUrl == this.props.webUrl && this.props.backUrl != webBackUrl.UPERVICEPAY) {
            this.backPage();
        } else if (this.props.backUrl == webBackUrl.UPERVICEPAY) {
            this.props.showModal(false);
            this.props.callBack();
            this.backPage();
        } else {
    ...
    onNavigationStateChange = (navState) => {
        ...
        if (oldUrl == 'http://' + this.props.backUrl + '/') {
            ...
            } else if (oldUrl == 'http://' + webBackUrl.UPERVICEPAY + '/') {
                //this.props.callBack();
                this.backPage();
            } else {
                this.backPage();
