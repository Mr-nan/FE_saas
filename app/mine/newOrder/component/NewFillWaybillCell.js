    ...
    render() {
        ...
        if(cellData.tailView){
            this.contentView = (<View style={[styles.cellType1]}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{flexDirection:'row',alignItems:'center'}}>
                        {
                            cellData.leftImage && <Image style={{marginRight:Pixel.getPixel(5)}} source={cellData.leftImage}/>
                        }
                        <Text allowFontScaling={false} style={[styles.cellTitle,cellData.titleStyle]}>{cellData.title}</Text>
                        {
                            cellData.rightImage && <Image style={{marginLeft:Pixel.getPixel(5)}} source={cellData.rightImage}/>
                        }
                        {
            ...
            this.contentView = (<View style={[styles.cellType1]}>
                ...
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    <Text allowFontScaling={false} style={[styles.cellValue,cellData.valueStyle]}>{cellData.value}</Text>
                    {
                        cellData.isShowTail &&
