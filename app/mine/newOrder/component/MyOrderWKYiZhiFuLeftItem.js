...
export  default class MyOrderWKYiZhiFuLeftItem extends PureComponent {
    ...
    render() {
        ...
        return (
            <View style={{marginTop:Pixel.getPixel(92),marginLeft:Pixel.getPixel(167)}}>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(14), fontWeight:'bold',backgroundColor: '#00000000'}}>尾款已到账</Text>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(11),marginTop:Pixel.getPixel(8),backgroundColor: '#00000000'}}>请等待物流验车，验车通过后方可提款</Text>
