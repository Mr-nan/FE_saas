...
export  default class MyOrderInfoYiJieQingItem extends PureComponent {
    ...
    render() {
        ...
        return (
            <View style={{marginTop:Pixel.getPixel(92),marginLeft:Pixel.getPixel(167)}}>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(18), fontWeight:'bold',backgroundColor: '#00000000'}}>全款已付清</Text>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(12),marginTop:Pixel.getPixel(8),backgroundColor: '#00000000'}}>交易完成</Text>
