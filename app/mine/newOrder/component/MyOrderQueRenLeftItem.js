...
export  default class MyOrderQueRenLeftItem extends PureComponent {
    ...
    render() {
        ...
        return (
            <View style={{marginTop:Pixel.getPixel(108),marginLeft:Pixel.getPixel(167)}}>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(18), fontWeight:'bold',backgroundColor: '#00000000'}}>请确认成交价和订金</Text>
