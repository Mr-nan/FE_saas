...
export  default class MyOrderDingJinSuccessLeftItem extends PureComponent {
    ...
    render() {
        ...
        return (
            <View style={{marginTop:Pixel.getPixel(92),marginLeft:Pixel.getPixel(167)}}>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(18), fontWeight:'bold',backgroundColor: '#00000000'}}>订金支付成功</Text>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(12),marginTop:Pixel.getPixel(8),backgroundColor: '#00000000'}}>请支付尾款</Text>
