...
export  default class MyOrderXianXiaLeftItem extends PureComponent {
    ...
    render() {
        ...
        return (
            <View style={{marginTop:Pixel.getPixel(98),marginLeft:Pixel.getPixel(167)}}>
                <Text style={{color:'#fff',fontSize:Pixel.getPixel(18), fontWeight:'bold',backgroundColor: '#00000000'}}>线下支付中</Text>
