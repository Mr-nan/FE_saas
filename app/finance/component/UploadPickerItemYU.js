...
import  UploadPickerChildItemYU from './UploadPickerChildItemYU';
import ImagePicker from "react-native-image-picker";
import * as MyUrl from '../../constant/appUrls';

export  default class UploadPickerItemYU extends PureComponent {
    ...
    render() {
        ...
        {
            let length = 0;
            if (this.state.childMovie.list.length < this.props.totalNum) {
            ...
            movieItems.push(<UploadPickerChildItemYU totalNum = {this.props.totalNum} allLength={this.state.childMovie.list.length} key={0} index={0}
                                                     mOnPress={(index) => {
                                                         this.selectPhotoTapped(movie.code)
                                                     }}/>)
        }
