...
export default class Grid extends Component {
    ...
    constructor(props: Object) {
        ...
        this.state = {
            dataSource: this.ds.cloneWithRows(this._prepareData(this.props.data)),
        };
    }

    refresh = (data)=>{
        this.setState({
            dataSource: this.ds.cloneWithRows(this._prepareData(data)),
        });
    };

    // componentWillReceiveProps(nextProps: Object) {
    //     this.setState({
    //         dataSource: this.ds.cloneWithRows(this._prepareData(nextProps.data)),
    //     });
    // }
