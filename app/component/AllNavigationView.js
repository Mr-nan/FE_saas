        ...
        return (
            <View style={[styles.navigation,wrapStyle,this.state.navigationBackgroundColor && {backgroundColor:this.state.navigationBackgroundColor}]}>
                <View style={styles.content}>
                    ...
                    {backIconClick && <Image style={styles.backIcon} source={wrapStyle? (wrapStyle.backgroundColor=='white'?require('../../images/mainImage/fanhui.png'):require('../../images/mainImage/navigatorBack.png')):require('../../images/mainImage/navigatorBack.png')}/>}
                     </TouchableOpacity>
